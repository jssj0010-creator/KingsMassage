(function(){
  function mount(){
    ...
    bar.id = "sticky-cta";
    bar.innerHTML =
      '<a class="tel" href="tel:010-4637-9556" aria-label="전화 상담 연결">전화 상담</a>' +
      '<a class="home" href="/" aria-label="메인 페이지로 이동">홈</a>' +
      '<a class="kakao" href="https://open.kakao.com/o/shGxbqRh" target="_blank" rel="noopener" aria-label="카카오톡 오픈채팅으로 연결">' +
